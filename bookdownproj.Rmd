...
<!--chapter:end:04-types.Rmd-->

# Descriptive studies

<!--chapter:end:05-descriptive.Rmd-->

# Simple Linear Regression

Simple regression analysis. 

<!--chapter:end:06-simple.Rmd-->

# Multiple Regression

<!--chapter:end:07-multiple.Rmd-->

# Logit and probit Models

<!--chapter:end:08-logit.Rmd-->

# Time Series Analysis – ARIMA Models

<!--chapter:end:09-arima.Rmd-->
